      ...
      <div className="container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-up">
            ...
            <Link to="/dashboard">
              <Button size="lg" className="bg-gradient-primary text-primary-foreground font-semibold text-base px-8 hover:opacity-90 transition-opacity shadow-glow">
                Analyze 100 conversations free
              </Button>
            </Link>
          </div>

          <div className="animate-fade-up" style={{ animationDelay: "0.2s" }}>
            {/* Dashboard mockup with stats overlay */}
            <div className="relative">
              ...
              {/* Floating stat cards */}
              <div className="absolute -bottom-4 -left-4 glass rounded-lg p-3 shadow-card animate-fade-in" style={{ animationDelay: "0.6s" }}>
                <div className="text-xs text-muted-foreground">Consistency Score</div>
                <div className="text-xl font-bold text-primary">78%</div>
              </div>
              <div className="absolute -top-4 -right-4 glass rounded-lg p-3 shadow-card animate-fade-in" style={{ animationDelay: "0.8s" }}>
                <div className="text-xs text-muted-foreground">Token Waste</div>
                <div className="text-xl font-bold text-warning">$2,340<span className="text-xs text-muted-foreground">/mo</span></div>
              </div>
              <div className="absolute top-1/2 -right-6 glass rounded-lg p-3 shadow-card animate-fade-in" style={{ animationDelay: "1s" }}>
