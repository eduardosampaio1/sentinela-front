// Projeção TypeScript DERIVADA do contrato público. ORIGEM: repo sentinela/docs/contracts; pelos
// gates `contract-authority` e `contract-sync`; extensões de Review vivem no módulo irmão.
...
export * from "./public-review.types";
