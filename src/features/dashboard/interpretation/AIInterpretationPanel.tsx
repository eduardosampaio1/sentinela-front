  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      {interpretation.executive_diagnosis && (
        <div>
          <p className="text-[10px] uppercase tracking-wide font-semibold text-[#2D3748] mb-2">Executive diagnosis</p>
      ...
      {interpretation.summary && interpretation.summary !== interpretation.executive_diagnosis && (
        <div>
          <p className="text-[10px] uppercase tracking-wide font-semibold text-[#2D3748] mb-2">Summary</p>
      ...
      {interpretation.main_risks && interpretation.main_risks.length > 0 && (
        <div>
          <p className="text-[10px] uppercase tracking-wide font-semibold text-[#2D3748] mb-2">Key risks</p>
          <div className="space-y-2">
            {interpretation.main_risks.map((risk, idx) => (
              ...
              >
                ...
                {risk.impact && (
                  <p className="text-xs text-[#475569] mt-1">Impact: {risk.impact}</p>
                )}
              </div>
            ))}
          </div>
      ...
      {interpretation.systemic_pattern && (
        <div>
          <p className="text-[10px] uppercase tracking-wide font-semibold text-[#2D3748] mb-2">Systemic pattern</p>
      ...
      {interpretation.priority_actions && interpretation.priority_actions.length > 0 && (
        <div>
          <p className="text-[10px] uppercase tracking-wide font-semibold text-[#2D3748] mb-2">Priority actions</p>
          <div className="space-y-2">
            {interpretation.priority_actions.map((action, idx) => (
              <div key={idx} className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#475569] mt-0.5">{action.reason}</p>
      ...
      {interpretation.confidence_notes && (
        <p className="text-xs text-[#2D3748] italic">{interpretation.confidence_notes}</p>
      )}
    </div>
  );
}
    ...
    <div className="card-base p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-[#475569] mt-0.5">Natural language analysis generated by AI</p>
        </div>
