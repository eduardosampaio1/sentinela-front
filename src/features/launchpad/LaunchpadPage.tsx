    ...
    <>
      ...
      <AppShell topBarTitle="Launchpad">
        <PageFrame maxWidth="xl">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              {analysisCompleted && (
                <Button
                  ...
                  size="sm"
                  className="rounded-xl bg-[rgba(34,211,238,0.10)] text-[#22D3EE] border border-[rgba(34,211,238,0.18)] hover:bg-[rgba(34,211,238,0.16)] flex-shrink-0"
                >
          ...
          {/* Format guidance */}
          <div className="mt-8 flex items-start gap-3 px-5 py-4 rounded-xl bg-[rgba(34,211,238,0.04)] border border-[rgba(34,211,238,0.08)]">
