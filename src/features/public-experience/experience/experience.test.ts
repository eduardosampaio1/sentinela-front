...
import { getExperienceScenarios } from "./scenarios";
import { getPublicExperienceCopy } from "../content/copy";
...
describe("Web Summit experience", () => {
  ...
  it("keeps scenarios data-driven and distinct", () => {
    const experienceScenarios = getExperienceScenarios(getPublicExperienceCopy("en", "official"));
