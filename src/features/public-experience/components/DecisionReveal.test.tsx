...
const renderDecision = (result: ExperienceResult) => render(
  <PublicExperienceConfigProvider variant="official"><DecisionReveal result={result} /></PublicExperienceConfigProvider>,
);
...
describe("DecisionReveal", () => {
  ...
  it("turns the actual decision into a post-answer visual explanation", () => {
    const { container } = renderDecision(riskyResult);
