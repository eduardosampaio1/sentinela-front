...
const wrap = (ui: React.ReactNode) => <PublicExperienceConfigProvider variant="official">{ui}</PublicExperienceConfigProvider>;
...
describe("PromptComposer", () => {
  it("grows with multiline content and caps its height before scrolling", () => {
    const view = render(wrap(<PromptComposer value="Short" {...callbacks} />));
